...
2. Git clone the flannel repo. It MUST be placed in your GOPATH under `github.com/xiaomaojames/flannel-io`: `cd $GOPATH/src; git clone https://github.com/xiaomaojames/flannel-io.git`
